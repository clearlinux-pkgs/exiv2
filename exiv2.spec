...
Source0  : https://github.com/Exiv2/exiv2/archive/v0.28.2/exiv2-0.28.2.tar.gz
...
%prep
%setup -q -n exiv2-0.28.2
cd %{_builddir}/exiv2-0.28.2
pushd ..
cp -a exiv2-0.28.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720026471
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libexiv2.so.0.28.2
/usr/lib64/libexiv2.so.0.28.2
