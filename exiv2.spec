...
Source0  : https://github.com/Exiv2/exiv2/archive/v0.28.4/exiv2-0.28.4.tar.gz
...
%prep
%setup -q -n exiv2-0.28.4
cd %{_builddir}/exiv2-0.28.4
pushd ..
cp -a exiv2-0.28.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739221527
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libexiv2.so.0.28.4
/usr/lib64/libexiv2.so.0.28.4
