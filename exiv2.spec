...
Version  : 0.28.1
Release  : 52
URL      : https://github.com/Exiv2/exiv2/archive/v0.28.1/exiv2-0.28.1.tar.gz
Source0  : https://github.com/Exiv2/exiv2/archive/v0.28.1/exiv2-0.28.1.tar.gz
...
%prep
%setup -q -n exiv2-0.28.1
cd %{_builddir}/exiv2-0.28.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1701954395
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libexiv2.so.0.28.1
/usr/lib64/libexiv2.so.0.28.1
