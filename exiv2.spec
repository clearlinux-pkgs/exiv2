...
Source0  : https://github.com/Exiv2/exiv2/archive/v0.28.5/exiv2-0.28.5.tar.gz
...
%prep
%setup -q -n exiv2-0.28.5
cd %{_builddir}/exiv2-0.28.5
pushd ..
cp -a exiv2-0.28.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1740161921
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/cmake/exiv2/exiv2Targets-relwithdebinfo.cmake
/usr/lib64/cmake/exiv2/exiv2Targets.cmake
/usr/lib64/libexiv2.so
/usr/lib64/pkgconfig/exiv2.pc

%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libexiv2.so.0.28.5
/usr/lib64/libexiv2.so.0.28.5
