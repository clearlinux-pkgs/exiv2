...
export LANG=C
export SOURCE_DATE_EPOCH=1556546624
mkdir -p clr-build
pushd clr-build
...
%files
%defattr(-,root,root,-)
/usr/lib64/exiv2/cmake/exiv2Config-relwithdebinfo.cmake
/usr/lib64/exiv2/cmake/exiv2Config.cmake
/usr/lib64/exiv2/cmake/exiv2ConfigVersion.cmake
